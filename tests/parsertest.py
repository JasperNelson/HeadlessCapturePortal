...
# #tests to see if the error checking is working
# def  test_Bad_Login_Files():
#     with pytest.raises(UnicodeDecodeError):
#         TOMLparser(r"./TestingFiles/CORRUPTED_TOML")
#     with pytest.raises(ValueError):
#         TOMLparser(r"./TestingFiles/BADLOGIN.toml")
#     with pytest.raises(ValueError):
#         TOMLparser(r"./TestingFiles/BADLOGIN_2.toml")
#     with pytest.raises(ValueError):
#         TOMLparser(r"./TestingFiles/BADLOGIN_3.toml")
#     with pytest.raises(TOMLDecodeError):
#         TOMLparser(r"./TestingFiles/BAD_TOML.toml")
