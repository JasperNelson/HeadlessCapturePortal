...
assert(str((LoginParser(r"./Examplelogins/EXAMPLE.toml")).export) == "_ingest(Actions=[Action(type='click', id={'id': 'example'}, content=None, wait=None), Action(type='click', id={'contains': 'garply thud'}, content=None, wait=None), Action(type='click', id={'name': 'examplename'}, content=None, wait=None), Action(type='click', id={'type': 'checkbox'}, content=None, wait=None), Action(type='click', id={'xpath': 'xpathere'}, content=None, wait=None), Action(type='wait', id=None, content=None, wait=30), Action(type='text', id={'name': 'exname'}, content=None, wait=None), Action(type='text', id={'xpath': 'xpath'}, content={'value': 'examplestringEGUserName'}, wait=None), Action(type='text', id={'xpath': 'xpath'}, content={'keyring': 'YourUserName'}, wait=None), Action(type='move', id={'href': 'href_url'}, content=None, wait=None), Action(type='move', id={'id': 'ID'}, content=None, wait=None)], URL='example.com', Backend='Debug')")
