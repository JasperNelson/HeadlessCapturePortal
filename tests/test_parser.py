...
assert(str((LoginParser(r"EXAMPLE.toml")).result())=="Ingest(Actions=[Action(type='click', id={'id': 'example'}, value=None), Action(type='click', id={'x-path': '/html/body/div/div/main/div/p[81]'}, value=None), Action(type='click', id={'name': 'examplename'}, value=None), Action(type='click', id={'type': 'checkbox'}, value=None), Action(type='wait', id=None, value={'wait': 30}), Action(type='text', id={'name': 'name'}, value=None), Action(type='text', id={'name': 'name'}, value={'value': 'examplestringEGUserName'}), Action(type='text', id={'name': 'password'}, value={'keyring': ['YourUserName']}), Action(type='move', id={'href': 'href_url'}, value=None), Action(type='move', id={'id': 'ID'}, value=None)], SSID='examplewifi', URL='https://example.com', MAC='00-B0-D0-63-C2-26', EnforceHTTPS=True)")
